...
const { fullPath } = useRoute('template-uid-slug')
...
<template>
    <div class="bg-#00EBFF pt-4px">
        <div class="bg-#01074B color-#fff">
            <div :style="{ visibility: visibleAd ? 'visible' : 'hidden' }" class="mx-auto max-w-660px min-h-100vh">
                <div class="i-svg-logo absolute right-20px top-20px hidden h-24px w-112px lg-block"></div>
                <div class="w-full">
                    <img :src="searchArticle.coverImg" alt="searchAdInfo.title" class="h-100px w-full object-cover" />
                </div>
                <div class="px-15px">
            ...
            /> -->
                ...
                >
                    ...
                    <p class="py-24px text-center text-14px">
                        The information on this site is of a general nature only and is not intended to address the
                        specific circumstances of any particular individual or entity. It is not intended or implied to
